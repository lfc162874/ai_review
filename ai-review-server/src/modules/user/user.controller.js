...
var UserController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('用户'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)('users')];
    ...
    var UserController = _classThis = /** @class */ (function () {
        ...
        UserController_1.prototype.getProfile = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.findById(user.sub)];
                });
            });
        };
        /**
         ...
         * 支持更新昵称、头像、个性签名。
         */
        UserController_1.prototype.updateProfile = function (user, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.update(user.sub, dto)];
                });
            });
        };
    ...
    (function () {
        ...
        _getProfile_decorators = [(0, common_1.Get)('me'), (0, swagger_1.ApiOperation)({ summary: '获取当前用户信息' }), (0, swagger_1.ApiResponse)({ status: 200, description: '返回当前用户信息' })];
        _updateProfile_decorators = [(0, common_1.Patch)('me'), (0, swagger_1.ApiOperation)({ summary: '更新当前用户信息' }), (0, swagger_1.ApiResponse)({ status: 200, description: '更新成功，返回更新后的用户信息' })];
