...
var JwtStrategy = function () {
    ...
    var _classSuper = (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy);
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        __extends(JwtStrategy_2, _super);
        function JwtStrategy_2(configService) {
         ...
         * @returns 注入到 request.user 的用户信息
         */
        JwtStrategy_2.prototype.validate = function (payload) {
            return { sub: payload.sub, email: payload.email };
        };
        return JwtStrategy_2;
    }(_classSuper));
    __setFunctionName(_classThis, "JwtStrategy");
    (function () {
        var _a;
