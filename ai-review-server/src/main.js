...
var interceptors_1 = require("./common/interceptors");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var logger, app, config, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    logger.log("\u5E94\u7528\u5DF2\u542F\u52A8\uFF0C\u76D1\u542C\u7AEF\u53E3 ".concat(port));
                    logger.log("Swagger \u6587\u6863\u5730\u5740: http://localhost:".concat(port, "/api/docs"));
                    return [2 /*return*/];
            }
        });
    });
