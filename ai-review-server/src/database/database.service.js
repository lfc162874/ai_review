 ...
 * 数据库服务
 *
 * 继承 PrismaClient，提供数据库操作能力。
 * 实现 OnModuleInit 和 OnModuleDestroy 接口，管理数据库连接的生命周期。
 * 应用启动时自动连接数据库，应用关闭时自动断开连接。
 */
...
var PrismaService = function () {
    ...
    var _classSuper = client_1.PrismaClient;
    var PrismaService = _classThis = /** @class */ (function (_super) {
        __extends(PrismaService_2, _super);
        function PrismaService_2() {
            ...
            _this.logger = new common_2.Logger(PrismaService.name);
            return _this;
        }
        /**
         * 模块初始化时自动连接数据库
         */
        PrismaService_2.prototype.onModuleInit = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
         ...
         * 模块销毁时自动断开数据库连接
         */
        PrismaService_2.prototype.onModuleDestroy = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
